            ...
            <div class="">
                <header>
                    <h2 class="text-lg font-medium text-gray-900 dark:text-gray-600">
                        {{ __('Music Style Create') }}
                    </h2>

                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        {{ __("Create music style.") }}
                    </p>
                </header>
                <form method="post" action="{{ route('family_instrument.store') }}" class="mt-6 space-y-6">
                    @csrf
                    <div>
                    ...
                    <div class="user_toggle">
                        ...
                        <input data-id="" name="style_status" class="toggle-class" type="checkbox" data-on="Active" data-off="Suspended" data-toggle="toggle" data-offstyle="danger">
