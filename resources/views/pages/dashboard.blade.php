...
<div class="row" style="justify-content: center; margin-bottom: 20px;">
    <div class="flex col-12 col-lg-5">
        <a href="{{ route('exportar_usuarios_suscritos') }}" class="btn btn-success btn-elevate btn-pill mr-2">
            <i class="flaticon2-download mr-2"></i> Excel Usuarios
        </a>
        <a href="{{ route('exportar_uso') }}" class="btn btn-success btn-elevate btn-pill mr-2">
            <i class="flaticon2-download mr-2"></i> Excel Uso
        </a>
        <a href="{{ route('exportar_uso_offline') }}" class="btn btn-success btn-elevate btn-pill">
            <i class="flaticon2-download mr-2"></i> Excel Offline
        </a>
    </div>
</div>
...
<input type="hidden" value="{{ json_encode($monthlyRequestCounts) }}" name="mothly_request"
    id="monthly_request_counts" />
...
<input type="hidden" value="{{ json_encode($dailyDetailViewCounts) }}" name="daily_detail_view"
    id="daily_detail_view_counts" />
...
<input type="hidden" value="{{ json_encode($dailyPersonalViewCounts) }}" name="daily_personal_view"
    id="daily_personal_view_counts" />
...
<div class="row" style="justify-content: center; gap: 5px;">
    ...
    <div class="flex col-12 col-lg-5">
        @include('pages.widgets._widget-daily-detail', [
        'class' => 'col-12 card-stretch card-stretch-half gutter-b',
        ])
    </div>

    <div class="flex col-12 col-lg-5">
        @include('pages.widgets._widget-daily-personal', [
        'class' => 'col-12 card-stretch card-stretch-half gutter-b',
        ])
    </div>
