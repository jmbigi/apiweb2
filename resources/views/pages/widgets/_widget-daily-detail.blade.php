    ...
    <div class="card-body d-flex flex-column p-0">
        <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
            ...
            <span class="symbol symbol-light-success symbol-45">
                <span class="text-dark-75 font-weight-bolder font-size-h3">{{ $daily_detail_view_count }}</span>
            </span>
        </div>
        <!-- Añade una clase o modifica el estilo inline para ajustar el ancho -->
        <div id="kt_stats_widget_daily_detail_chart" class="card-rounded-bottom"
