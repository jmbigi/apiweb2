...
@section('content')
<div class="login-forgot text-dark">
  <div class="mb-20">
  ...
  <form class="form" method="POST" action="{{ route('password.email') }}">
    ...
    <div class="form-group">
      <button type="submit"
        class="py-3 m-2 btn btn-pill btn-outline-dark font-weight-bold opacity-90 px-15">Request</button>
      <a href="{{ route('login') }}" id="kt_login_forgot_cancel"
        class="py-3 m-2 btn btn-pill btn-outline-dark font-weight-bold opacity-70 px-15">Cancel</a>
    </div>
  </form>
</div>
@endsection